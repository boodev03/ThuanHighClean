    ...
    <section className="container mx-auto pt-[50px]">
      <div className="flex flex-col lg:flex-row items-center">
        <div className="flex-1">
          <h2 className="mt-2 mb-4 text-[32px] lg:max-w-[70%] font-bold">
            Tầm nhìn
          </h2>
          <p className="lg:max-w-[70%] text-justify">
            <span className="text-primary font-medium">Thuan High Clean </span>
            định hướng phát triển thành một trung tâm dịch vụ vệ sinh uy tín –
            chất lượng – tận tâm hàng đầu tại Việt Nam. Chúng tôi sẽ luôn không
            ngừng đổi mới, sáng tạo để mang đến cho quý khách hàng các s ản phẩm
            dịch vụ làm sạch, góp phần nâng cao chất lượng môi trường sống và
            chung tay bảo vệ trái đất xanh.
          </p>
        </div>
        <img
          className="w-[230px]"
