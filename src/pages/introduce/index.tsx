      ...
      <section className="bg-[#F5F5F5] py-[60px]">
        <div className="container mx-auto ">
          ...
          <div className="lg:max-w-[50%] space-y-5 mb-4">
            ...
            <p className="text-justify">
              Hiện tại, Thuan High Clean cung cấp các dịch vụ tiện ích cho nhiều
              hộ gia đình & Công Ty ở khắp 5 tỉnh thành tại Việt Nam: TP.HCM,
              Long An, Bình Dương, Đồng Nai và Bà Rịa Vũng Tàu
            </p>
          </div>
          <div className="lg:max-w-[50%] space-y-5 mb-4">
            ...
            <p className="text-justify">
              Với mục tiêu mang đến cho khách hàng những trải nghiệm dịch vụ tốt
              nhất,
              <span className="text-primary font-semibold">
                Thuan High Clean
              </span>{" "}
